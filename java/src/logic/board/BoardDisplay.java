...
public class BoardDisplay extends Canvas implements Observer {
	...
	public BoardDisplay(java.applet.Applet applet, Game g) {
		...
		emptyBoard = applet.getImage(documentBase, "src/images/Board.png");
		whiteBoard = applet.getImage(documentBase, "src/images/White.png");
		blackBoard = applet.getImage(documentBase, "src/images/Black.png");
